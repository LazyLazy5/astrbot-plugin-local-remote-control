...
def test_qq_official_is_restricted_strategy_with_note():
    strategy = platform_strategy_from_umo("default_1000000000:FriendMessage:user-openid")
...
def test_format_platform_status_includes_note_for_restricted_channel():
    ...
    text = format_platform_status("default_1000000000:FriendMessage:user-openid")
